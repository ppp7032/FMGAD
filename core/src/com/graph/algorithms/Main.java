...
public class Main extends Game {
  ...
  public void loadGraph(final Graph loadedGraph) {
    ...
    for (int a = 0; a < loadedGraph.getNumberOfVertices(); a++) {
      ...
      vertexLabels.add(new Text(Character.toString((char) (a + 65)),
          graph.getXCoordinateOfVertex(a) * Graphics.scaleFactor,
          graph.getYCoordinateOfVertex(a) * Graphics.scaleFactor, Graphics.fonts[3],
