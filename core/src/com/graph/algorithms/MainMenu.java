...
public class MainMenu implements Screen {
    ...
    public MainMenu(final float scaleFactor) {
        ...
        stage.addActor(new Text("Further Maths Graph Algorithm Demonstrator", Gdx.graphics.getWidth() / 2f, 685 * scaleFactor, Text.generateFont("fonts/DmMonoRegular.ttf",40f*scaleFactor)));
        Skin skin=Text.generateSkin(Text.generateFont("fonts/DmMonoRegular.ttf",40f));
        ...
        newGraph.getLabel().setFontScale(0.65f * scaleFactor);
        ...
        loadGraph.getLabel().setFontScale(0.65f * scaleFactor);
        ...
        exit.getLabel().setFontScale(0.65f * scaleFactor);
