...
public class Text extends Actor {
  ...
  public Text(final String input, final float x, final float y, final BitmapFont font,
      final float[] colour, final int alignX, final int alignY,
      final float maxWidth) { //align -1 means left, 0 means centre, 1 means right
    this.font = font;
    fullText = input;
    this.colour = colour;
    this.alignX = alignX;
  ...
  public static BitmapFont generateFont(final String fontName, final float size,
